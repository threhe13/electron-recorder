...
const fb_model = tf.loadLayersModel('./fb_model/model.json')
const sb_model = tf.loadLayersModel('./sb_model/model.json')
...
function extract_patches(input, size, stride, rate, padding){
